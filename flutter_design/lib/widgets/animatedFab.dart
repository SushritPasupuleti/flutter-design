...
class FABDisplay extends StatefulWidget {
  @override
  _FABDisplayState createState() => _FABDisplayState();
}

class _FABDisplayState extends State<FABDisplay> with SingleTickerProviderStateMixin {
